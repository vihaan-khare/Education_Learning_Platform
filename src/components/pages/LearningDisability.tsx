/**
 * LearningDisability.tsx
 * 
 * FLOW: This page is shown to users whose detected disability profile
 * is 'learning' (e.g., dyslexia). The user is automatically routed
 * here after login (via profileRoutes.ts) or after onboarding detection.
 * 
 * The user does NOT know they are on a "Learning Disability" page —
